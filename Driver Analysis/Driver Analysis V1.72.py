...
#----Functions----#
def wltc (time, target_speed, actual_speed, upper_boundary, lower_boundary, filename, filecut, driver, sheet, errorcnt1, errortime1, violationcnt1, errorcnt2, errortime2, violationcnt2, violationtime2, errorcnt3, errortime3, violationcnt3, violationtime3, errorcnt4, errortime4, violationcnt4, violationtime4):
    ...
    axs1[0].text(0, 60.5, 'Violation Count: ' + violationcnt1 + ',  Violation Time: ' + violationtime1)
    ...
    axs1[1].text(589, 80.5, 'Violation Count: ' + violationcnt2 + ',  Violation Time: ' + violationtime2)
    ...
    axs2[0].text(1022, 101.5, 'Violation Count: ' + violationcnt3 + ',  Violation Time: ' + violationtime3)
    ...
    axs2[1].text(1477, 136.8, 'Violation Count: ' + violationcnt4 + ',  Violation Time: ' + violationtime4)
...
if cycle == 'WLTC Class3b TYPE 1' or cycle == 'WLTC Class3b TYPE 1 Development':
    ...
    wltc(time, target_speed, actual_speed, upper_boundary, lower_boundary, filename, filecut, driver, sheet, errorcnt1, errortime1, violationcnt1, errorcnt2, errortime2, violationcnt2, violationtime2, errorcnt3, errortime3, violationcnt3, violationtime3, errorcnt4, errortime4, violationcnt4, violationtime4)
